...
- `recipe/`  
  - `7x_flavor.md` — Mixture A (“7X flavor oil” + ethanol dilution)
  - `water_solution.md` — Mixture B (water-based ingredients)
  - `one_liter_batch.md` — Final 1 L assembly
  - `recipe.yaml` — Machine-readable recipe (for scaling)
- `docs/`
  - `background.md` — High-level method and reasoning
  - `safety.md` — Handling notes and hazards
- `DISCLAIMER.md` — Please read before attempting anything
- `REFERENCES.md` — Sources and citations (video + peer-reviewed paper)
- `CITATION.cff` — Citation metadata for reuse in academic contexts
